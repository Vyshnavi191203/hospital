// components/patient/AppointmentBooking.jsx
...
const AppointmentBooking = () => {
  ...
  const fetchDepartments = async () => {
    try {
      const res = await axios.get(`${API_BASE}/Appointment/departments`, {
  ...
  const fetchDoctors = async () => {
    ...
    try {
      const res = await axios.get(`${API_BASE}/Appointment/doctors-by-department`, {
        params: { department: selectedDepartment },
        headers: { Authorization: `Bearer ${token}` },
      });
      setDoctors(res.data);
    } catch {
      alert('No doctor available in this Department');
    }
  };
  ...
  const fetchAvailableDates = async () => {
    ...
    try {
      ...
      alert('Doctor is not available for this date');
    }
  };
  ...
  const fetchSlotsByDate = async () => {
    ...
    try {
      ...
      alert('Timeslots are not available for selected date.');
    }
  };
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      setBookingError('Failed to book appointment. You already have an appointment at the same date and time.');
    }
  };
